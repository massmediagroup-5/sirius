 ...
 */
class Version20160419114017 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE order_status ADD send_client TINYINT(1) NOT NULL, ADD send_manager TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE order_status DROP send_client, DROP send_manager');
