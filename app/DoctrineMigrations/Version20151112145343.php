 ...
 */
class Version20151112145343 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE characteristic_priorities (id INT AUTO_INCREMENT NOT NULL, categories_id INT DEFAULT NULL, characteristics_id INT DEFAULT NULL, priority INT DEFAULT NULL, create_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, update_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, INDEX fk_characteristic_priorities_categories1_idx (categories_id), INDEX fk_characteristic_priorities_characteristics1_idx (characteristics_id), UNIQUE INDEX id_UNIQUE (id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
