 ...
 */
class Version20161012132108 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE order_status ADD send_client_night_text VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE order_status_pay ADD send_client_night_text VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE order_status DROP send_client_night_text');
        $this->addSql('ALTER TABLE order_status_pay DROP send_client_night_text');
