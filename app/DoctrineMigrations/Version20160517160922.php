 ...
 */
class Version20160517160922 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE share ADD status TINYINT(1) NOT NULL, ADD start_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, ADD end_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, CHANGE create_time create_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE sessions CHANGE sess_id sess_id VARBINARY(255) NOT NULL');
        $this->addSql('ALTER TABLE share DROP status, DROP start_time, DROP end_time, CHANGE create_time create_time DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
