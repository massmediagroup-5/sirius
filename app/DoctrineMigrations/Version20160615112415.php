 ...
 */
class Version20160615112415 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE cities ADD ref VARCHAR(255) NOT NULL, ADD full_json LONGTEXT DEFAULT NULL, ADD active TINYINT(1) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE stores ADD ref VARCHAR(255) NOT NULL, ADD full_json LONGTEXT DEFAULT NULL, ADD active TINYINT(1) DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE cities DROP ref, DROP full_json, DROP active');
        ...
        $this->addSql('ALTER TABLE stores DROP ref, DROP full_json, DROP active');
