 ...
 */
class Version20160109113946 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX `index` ON categories');
        $this->addSql('ALTER TABLE categories CHANGE create_time create_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, CHANGE update_time update_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, CHANGE parrent parrent_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE categories ADD CONSTRAINT FK_3AF34668C83F53CA FOREIGN KEY (parrent_id) REFERENCES categories (id)');
        $this->addSql('CREATE INDEX IDX_3AF34668C83F53CA ON categories (parrent_id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE categories DROP FOREIGN KEY FK_3AF34668C83F53CA');
        $this->addSql('DROP INDEX IDX_3AF34668C83F53CA ON categories');
        $this->addSql('ALTER TABLE categories CHANGE create_time create_time DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE update_time update_time DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE parrent_id parrent INT DEFAULT NULL');
        $this->addSql('CREATE INDEX `index` ON categories (parrent)');
