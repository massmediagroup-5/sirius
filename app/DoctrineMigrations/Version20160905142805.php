 ...
 */
class Version20160905142805 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX IDX_3B2EEEC032BC6DCB ON email_and_sms_distribution');
        $this->addSql('ALTER TABLE email_and_sms_distribution DROP sms_infos_id, CHANGE create_time create_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, CHANGE update_time update_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP');
        ...
        $this->addSql('ALTER TABLE sms_info ADD users_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE sms_info ADD CONSTRAINT FK_70A4AD0167B3B43D FOREIGN KEY (users_id) REFERENCES users (id)');
        $this->addSql('CREATE INDEX IDX_70A4AD0167B3B43D ON sms_info (users_id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE email_and_sms_distribution ADD sms_infos_id INT DEFAULT NULL, CHANGE create_time create_time DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE update_time update_time DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_3B2EEEC032BC6DCB ON email_and_sms_distribution (sms_infos_id)');
        ...
        $this->addSql('ALTER TABLE sms_info DROP FOREIGN KEY FK_70A4AD0167B3B43D');
        $this->addSql('DROP INDEX IDX_70A4AD0167B3B43D ON sms_info');
        $this->addSql('ALTER TABLE sms_info DROP users_id');
