 ...
 */
class Version20160614113456 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE novaposhta ADD warehouse_ref VARCHAR(255) DEFAULT NULL, ADD phone VARCHAR(45) DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE novaposhta DROP warehouse_ref, DROP phone');
