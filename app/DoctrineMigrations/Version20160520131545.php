 ...
 */
class Version20160520131545 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE unisender (id INT AUTO_INCREMENT NOT NULL, phones TEXT DEFAULT NULL, api_key VARCHAR(255) DEFAULT NULL, sender_name VARCHAR(255) DEFAULT NULL, active TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE unisender');
