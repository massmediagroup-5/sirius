 ...
 */
class Version20160919104050 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE history ADD product_model_specific_size_id INT DEFAULT NULL, ADD product_model_id BIGINT DEFAULT NULL, CHANGE create_time create_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP');
        $this->addSql('ALTER TABLE history ADD CONSTRAINT FK_27BA704B6054F798 FOREIGN KEY (product_model_specific_size_id) REFERENCES product_model_specific_size (id)');
        $this->addSql('ALTER TABLE history ADD CONSTRAINT FK_27BA704BB2C5DD70 FOREIGN KEY (product_model_id) REFERENCES product_models (id)');
        $this->addSql('CREATE INDEX IDX_27BA704B6054F798 ON history (product_model_specific_size_id)');
        $this->addSql('CREATE INDEX IDX_27BA704BB2C5DD70 ON history (product_model_id)');
        $this->addSql('ALTER TABLE product_models CHANGE create_time create_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, CHANGE update_time update_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, CHANGE text_label text_label VARCHAR(255) DEFAULT NULL, CHANGE text_label_color text_label_color VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE menu_items DROP retail, CHANGE create_time create_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, CHANGE update_time update_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE history DROP FOREIGN KEY FK_27BA704B6054F798');
        $this->addSql('ALTER TABLE history DROP FOREIGN KEY FK_27BA704BB2C5DD70');
        $this->addSql('DROP INDEX IDX_27BA704B6054F798 ON history');
        $this->addSql('DROP INDEX IDX_27BA704BB2C5DD70 ON history');
        $this->addSql('ALTER TABLE history DROP product_model_specific_size_id, DROP product_model_id, CHANGE create_time create_time DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
        ...
        $this->addSql('ALTER TABLE menu_items ADD retail TINYINT(1) DEFAULT \'0\' NOT NULL, CHANGE create_time create_time DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE update_time update_time DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
        ...
        $this->addSql('ALTER TABLE product_models CHANGE text_label text_label VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, CHANGE text_label_color text_label_color VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, CHANGE create_time create_time DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE update_time update_time DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
