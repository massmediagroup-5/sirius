 ...
 */
class Version20160419122113 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE order_product_size DROP FOREIGN KEY FK_7EE892A1498DA827');
        ...
        $this->addSql('ALTER TABLE order_product_size ADD CONSTRAINT FK_7EE892A1498DA827 FOREIGN KEY (size_id) REFERENCES product_model_specific_size (id)');
        ...
        $this->addSql('ALTER TABLE orders ADD quick_flag TINYINT(1) DEFAULT \'0\' NOT NULL, CHANGE create_time create_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, CHANGE update_time update_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE orders DROP quick_flag, CHANGE create_time create_time DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE update_time update_time DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
