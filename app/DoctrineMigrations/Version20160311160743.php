 ...
 */
class Version20160311160743 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE product_models CHANGE create_time create_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, CHANGE update_time update_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, CHANGE wholesale_price wholesale_price NUMERIC(8, 2) DEFAULT \'0\' NOT NULL, CHANGE wholesale_oldprice wholesale_oldprice NUMERIC(8, 2) DEFAULT \'0\' NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE product_models CHANGE wholesale_price wholesale_price NUMERIC(8, 2) DEFAULT NULL, CHANGE wholesale_oldprice wholesale_oldprice NUMERIC(8, 2) DEFAULT NULL, CHANGE create_time create_time DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE update_time update_time DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
