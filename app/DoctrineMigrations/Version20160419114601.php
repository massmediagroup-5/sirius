 ...
 */
class Version20160419114601 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE order_status CHANGE code code VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE order_status CHANGE code code VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci');
