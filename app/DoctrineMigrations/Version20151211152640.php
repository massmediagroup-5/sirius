 ...
 */
class Version20151211152640 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE product_models ADD in_stock TINYINT(1) DEFAULT NULL, CHANGE create_time create_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, CHANGE update_time update_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP');
        $this->addSql('CREATE INDEX stock ON product_models (in_stock)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX stock ON product_models');
        $this->addSql('ALTER TABLE product_models DROP in_stock, CHANGE create_time create_time DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE update_time update_time DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
