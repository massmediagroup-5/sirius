 ...
 */
class Version20160721143616 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE social_networks (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, link TEXT DEFAULT NULL, picture VARCHAR(255) DEFAULT NULL, active TINYINT(1) DEFAULT NULL, UNIQUE INDEX id_UNIQUE (id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
