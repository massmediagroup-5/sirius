 ...
 */
class Version20160401173236 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE main_banners (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) DEFAULT NULL, title_button VARCHAR(255) DEFAULT NULL, alias VARCHAR(255) DEFAULT NULL, picture VARCHAR(255) DEFAULT NULL, priority INT DEFAULT NULL, active TINYINT(1) DEFAULT NULL, wide TINYINT(1) DEFAULT NULL, create_time DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, update_time DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
