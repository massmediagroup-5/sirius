 ...
 */
class Version20160427182932 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE product_models_has_recommended (model_id BIGINT NOT NULL, recommended_model_id BIGINT NOT NULL, INDEX IDX_2A328F7B7975B7E7 (model_id), INDEX IDX_2A328F7BF6C230E3 (recommended_model_id), PRIMARY KEY(model_id, recommended_model_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE product_models_has_recommended ADD CONSTRAINT FK_2A328F7B7975B7E7 FOREIGN KEY (model_id) REFERENCES product_models (id)');
        $this->addSql('ALTER TABLE product_models_has_recommended ADD CONSTRAINT FK_2A328F7BF6C230E3 FOREIGN KEY (recommended_model_id) REFERENCES product_models (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE product_models_has_recommended');
