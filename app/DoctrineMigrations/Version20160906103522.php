 ...
 */
class Version20160906103522 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE orders CHANGE create_time create_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, CHANGE update_time update_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, CHANGE sms_info_id order_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE orders ADD CONSTRAINT FK_E52FFDEE8D9F6D38 FOREIGN KEY (order_id) REFERENCES sms_info (id)');
        $this->addSql('CREATE INDEX IDX_E52FFDEE8D9F6D38 ON orders (order_id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE orders DROP FOREIGN KEY FK_E52FFDEE8D9F6D38');
        $this->addSql('DROP INDEX IDX_E52FFDEE8D9F6D38 ON orders');
        $this->addSql('ALTER TABLE orders CHANGE create_time create_time DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE update_time update_time DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE order_id sms_info_id INT DEFAULT NULL');
