 ...
 */
class Version20160419122921 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE order_status ADD send_client_text VARCHAR(255) DEFAULT NULL, ADD send_manager_text VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE order_status DROP send_client_text, DROP send_manager_text');
