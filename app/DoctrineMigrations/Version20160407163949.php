 ...
 */
class Version20160407163949 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX wholesale_oldprice ON product_models');
        $this->addSql('ALTER TABLE product_models DROP oldprice, CHANGE create_time create_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, CHANGE update_time update_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP');
        ...
        $this->addSql('ALTER TABLE cart CHANGE create_time create_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, CHANGE update_time update_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, CHANGE original_total_price discounted_total_price NUMERIC(10, 2) DEFAULT \'0\' NOT NULL');
        ...
        $this->addSql('ALTER TABLE orders CHANGE create_time create_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, CHANGE update_time update_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, CHANGE original_total_price discounted_total_price NUMERIC(10, 2) DEFAULT \'0\' NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE cart CHANGE create_time create_time DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE update_time update_time DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE discounted_total_price original_total_price NUMERIC(10, 2) DEFAULT \'0.00\' NOT NULL');
        ...
        $this->addSql('ALTER TABLE orders CHANGE create_time create_time DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE update_time update_time DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE discounted_total_price original_total_price NUMERIC(10, 2) DEFAULT \'0.00\' NOT NULL');
        ...
        $this->addSql('ALTER TABLE product_models ADD oldprice NUMERIC(8, 2) DEFAULT NULL, CHANGE create_time create_time DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE update_time update_time DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
        $this->addSql('CREATE INDEX oldprice ON product_models (oldprice)');
        $this->addSql('CREATE INDEX wholesale_oldprice ON product_models (oldprice)');
